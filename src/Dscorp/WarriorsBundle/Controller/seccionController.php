...
use Dscorp\WarriorsBundle\Entity\seccion;
use Dscorp\WarriorsBundle\Form\seccionType;
...
class seccionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DscorpWarriorsBundle:seccion')->findAll();

        return $this->render('DscorpWarriorsBundle:seccion:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DscorpWarriorsBundle:seccion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DscorpWarriorsBundle:seccion')->find($id);
        ...
        return $this->render('DscorpWarriorsBundle:seccion:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DscorpWarriorsBundle:seccion:edit.html.twig', array(
            'entity'      => $entity,
